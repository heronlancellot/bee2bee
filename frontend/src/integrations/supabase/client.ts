...
// Use the SSR helper for the browser so PKCE code_verifier is stored in cookies
// and available to the server during the auth code exchange.
...
// Normalize URL (avoid trailing slash that can cause subtle issues)
